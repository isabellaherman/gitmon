  ...
  return (
    <div className="text-center mb-6">
      ...
      <div className="flex items-center justify-center gap-2 mb-3">
        <h4 className="text-xl font-bold" style={{ fontFamily: 'Minecraftia, monospace' }}>
          {selectedMonster.name}
        </h4>
        <span
          className="text-lg font-bold text-primary border border-primary/30 bg-primary/10 rounded-full px-2 py-1"
      ...
      <div className="flex gap-2 justify-center mb-4">
        <span
          className={`px-3 py-1 rounded-full text-white text-xs font-medium uppercase ${getTypeColor(selectedMonster.type)}`}
        >
        ...
        <div className="bg-muted rounded-lg p-3 text-center">
          <p className="text-2xl font-bold text-primary">
            {currentUserInLeaderboard?.xp?.toLocaleString() ||
              session?.user?.xp?.toLocaleString() ||
              0}{' '}
            XP
          </p>
