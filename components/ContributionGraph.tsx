      ...
      <div className="flex flex-col items-center space-y-2">
            ...
            <div key={weekIndex} className="flex flex-col gap-1">
              {week.map((intensity, dayIndex) => (
                <div
                  ...
                  className={`h-2.5 w-2.5 rounded-sm ${getIntensityColor(intensity)} transition-colors`}
        ...
        <div className="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400">
          ...
          <div className="flex gap-1">
            ...
            <div className="h-2.5 w-2.5 rounded-sm bg-green-300 dark:bg-green-700" />
            <div className="h-2.5 w-2.5 rounded-sm bg-green-400 dark:bg-green-600" />
            <div className="h-2.5 w-2.5 rounded-sm bg-green-500 dark:bg-green-500" />
          </div>
          <span>More</span>
        </div>
      </div>
