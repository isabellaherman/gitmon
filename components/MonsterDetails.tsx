...
const getMonsterDescription = (monster: Monster) => {
  ...
  return descriptions[monster.name as keyof typeof descriptions] || "A mysterious GitMon with unknown abilities.";
};
...
const getMonsterStats = (monster: Monster) => {
  ...
  return stats[monster.name as keyof typeof stats] || { attack: 75, defense: 75, speed: 75, special: 75 };
};
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <span className={`px-3 py-2 rounded-full text-white text-sm font-medium uppercase ${getTypeColor(monster.type)}`}>
            {monster.type}
          </span>
        </div>
      </div>
